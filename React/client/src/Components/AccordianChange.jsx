...
function AccordianChange() {
  ...
  let [theme, setTheme] = useState({color:"black", backgroundColor:"white"});
  ...
  function changeColor() {
    ...
    setTheme(
      theme.color ==="black"?{color:"white", backgroundColor:"black"}:{color:"black", backgroundColor:"white"}
    )
  ...
  return (
    ...
    <div>
      ...
      <button className="btn btn-primary" onClick={changeColor}>Click</button>
    </div>
  )
}

export default AccordianChange
